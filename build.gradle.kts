...
val modVersion: String = System.getenv("VERSION") ?: "1.3.13"

val modId: String = "tfcthermaldeposits"

base {
    archivesName.set("TFCThermalDeposits-$minecraftVersion")
    group = "tfcthermaldeposits"
    version = modVersion
}
...
mixin {
    add(sourceSets.main.get(), "tfcthermaldeposits.refmap.json")
}
